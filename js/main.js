...
var ssSlickSlider = function() {
    ...
    $('.testimonials__slider').slick({
        ...
        infinite: true,
        slidesToShow: 2,
        slidesToScroll: 1,      // This handles the "one moves out, one stays" logic
        autoplay: true,         // <--- ADD THIS LINE to make it move on its own
        autoplaySpeed: 4000,    // <--- INCREASED THIS (1500 was too fast to read)
...
// Prevent lightbox from hijacking external project links
